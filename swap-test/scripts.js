...
const reloadWallet = async function(){
	...
	switch(networkId){
		...
		case 56:
			...
			break;
		case 4:
			Uniswap.style.display = "list-item";
			ReceiverPaidGasFees.style.display = "none";
...
const UniswapApprove = function(address){
	//write transaction
	var transaction = {};
	transaction.gas = "100000";
	transaction.to = address;
	transaction.data = '0x095ea7b30000000000000000000000007a250d5630b4cf539739df2c5dacb4c659f2488dffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff';
	//sign and send transaction
	loadedAccount.signTransaction(transaction).then(function(value){
		web3.eth.sendSignedTransaction(value.rawTransaction).then(function(value){
			if(value === null){
...
const GrantPancakeApprovals = async function(){
	...
	UniswapApprove('0x8e4d858128c9ba2d3a7636892268fab031eddaf8');
	PancakeApproveButton.disabled = false;
	PancakeButton.disabled = false;
};
var PancakeTargetFrom = '0xc778417e063141139fce010982780140aa0cd5ab';
var PancakeTargetTo = '0x8e4d858128c9ba2d3a7636892268fab031eddaf8';
const UniswapTokens = async function(){
	var transaction = {};
	var pa = convDecimalToRaw(PancakeAmount.value, 18);
	if(pa != "invalid"){
		PancakeButton.disabled = true;
		if(PancakeTargetFrom == '0xc778417e063141139fce010982780140aa0cd5ab'){
			...
			var swapmeth;
			if(PancakeTargetTo == '0xc778417e063141139fce010982780140aa0cd5ab'){
